      ...
      <div className={styles.usa}>
        ...
        <div>
          <p>
            ...
            one of the best and most popular choices: Indian students account
            for 18% of the total international student population in the United
            States. This is because US universities are the gold-standard for
            higher education, offering a large variety of exciting program
            options and unmatched academic flexibility, giving students a chance
            to explore their interests inside and outside the classroom.
          </p>
          <div>
            <h2>Get Admission to Top US Universities</h2>
            <p>
              Getting admission to top US universities is no piece of cake, and
              things tend to get competitive as people around the world are
              vying for a spot in the best universities. That’s where Jamboree
              comes in: we guide you through the application and post-admission
              stages of your journey and help you achieve your dreams!
            </p>
          </div>
          <div>
            <h2>Scholarships & Living Costs:</h2>
            <p>
              Undoubtedly, the cost of living and tuition fees in US
              universities are high. But there’s no need to fret: most colleges
              and universities in the US offer substantial scholarships and
              financial aid to international students. The process of applying
              to these scholarships, we know, is daunting; so we’re here to
              mentor each stage and help you fulfill your goals!
            </p>
          </div>
          <div>
        ...
        <div>
          ...
          <div className={styles.cs}>
            ...
            <div>
              <Image src={u2} alt="u" />
              <p>
                Vibrant Campus Life and Diverse International Student
                Communities
              </p>
            </div>
            <div>
            ...
            <div>
              <Image src={u5} alt="u" />
              <p>
                Generous Financial Aid and Scholarships for International
                Students
              </p>
            </div>
            <div>
